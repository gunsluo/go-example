...
// Source: github.com/gunsluo/go-example/grpc/helloworld/pb (interfaces: GreeterClient)
...
import (
	...
	pb "github.com/gunsluo/go-example/grpc/helloworld/pb"
...
func (m *MockGreeterClient) SayHello(arg0 context.Context, arg1 *pb.HelloRequest, arg2 ...grpc.CallOption) (*pb.HelloReply, error) {
