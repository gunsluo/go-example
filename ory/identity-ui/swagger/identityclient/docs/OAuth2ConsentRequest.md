...
**Challenge** | Pointer to **string** | ID is the identifier (\\\&quot;authorization challenge\\\&quot;) of the consent authorization request. It is used to identify the session. | [optional] 
