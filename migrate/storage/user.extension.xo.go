...
// UserByID generated by PK__user__3213E83F1C7DDFEF
...
// innerUserByIDGraphQL retrieves a row from 'dbo.user' as a User.
...
func (r *RootResolver) innerUserByIDGraphQL(ctx context.Context, args struct {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, `unable to get dbo.user`)
	}
