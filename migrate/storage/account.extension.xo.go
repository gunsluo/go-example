...
// AccountByID generated by PK__account__3213E83F136498D2
...
// innerAccountByIDGraphQL retrieves a row from 'dbo.account' as a Account.
...
func (r *RootResolver) innerAccountByIDGraphQL(ctx context.Context, args struct {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, `unable to get dbo.account`)
	}
...
// AccountBySubject generated by account_subject_ak
...
// innerAccountBySubjectGraphQL retrieves a row from 'dbo.account' as a Account.
