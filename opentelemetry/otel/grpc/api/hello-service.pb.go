...
func (*UnimplementedHelloServiceServer) SayHelloServerStream(req *HelloRequest, srv HelloService_SayHelloServerStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloServerStream not implemented")
}
func (*UnimplementedHelloServiceServer) SayHelloClientStream(srv HelloService_SayHelloClientStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloClientStream not implemented")
}
func (*UnimplementedHelloServiceServer) SayHelloBidiStream(srv HelloService_SayHelloBidiStreamServer) error {
